...
const AddChildToAttendance = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const Data = {
            ...
            admin_signature: attendance.admin_signature
        }




        axios.post('http://localhost:3000/auth/add_child_to_attendance', Data)
            .then(result => {
                if (result.data.Status) {
...
export default AddChildToAttendance