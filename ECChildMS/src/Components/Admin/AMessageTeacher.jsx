...
const AMessageTeacher = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const Data = {
            admin_sender: messageTeacher.admin_sender,
        ...
        axios.post('http://localhost:3000/auth/message_a_teacher', Data)
            .then(result => {
                if (result.data.Status) {
            ...
            <div className='p-3 rounded w-50 border'>
                ...
                <form className='row g-1' onSubmit={handleSubmit}>
                    ...
                    <div className='col-12 mt-4 p-2'>
                        ...
                        <Link to={'/dashboard/message/' + adminId} className="btn btn-light w-100">Cancel</Link>
                    </div>
                </form>
            </div>
        </div >
...
export default AMessageTeacher