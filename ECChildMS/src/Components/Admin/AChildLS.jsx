...
const AChildLS = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3000/auth/child_ls/${id}`)
            .then(result => {
            ...
            <div className="col-md-12">
                <div className="container">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div>
                            <Link to={`/dashboard/learning_story_detail/${learningStory.created_month}`} className='btn btn-lg p-2' title="Return">
