...
const TCreateSleepChart = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const Data = {
            ...
            person_who_created: sleepChart.person_who_created
        }




        axios.post('http://localhost:3000/teacher/create_sleep_chart', Data)
            .then(result => {
    ...
    return (
        <div className='d-flex justify-content-center align-items-center mt-3'>
            <div className='p-3 rounded w-50 border'>
                <h3 className='text-center'>Create a Sleep Chart</h3>
...
export default TCreateSleepChart