...
const CMealDetail = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3000/child/meal_chart/${id}`)
            .then(result => {
        ...
        <div>
            <div className="container">
                <div className="d-flex justify-content-between align-items-center mt-auto p-3 m-3">
                    ...
                    <div>
                        <Link to={'/child_dashboard/meal_chart'} className='btn btn-lg p-2' title="Return"><i className="bi bi-arrow-left-circle text-dark"></i></Link>
                    </div>
                </div>
            </div >
            <div>
